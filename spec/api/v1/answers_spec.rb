...
describe 'Answers API', type: :request do
  ...
  describe 'GET /api/v1/questions/:question_id/answers' do
    ...
    context 'authorized' do
      ...
      it_behaves_like 'Public fields' do
        let(:attrs) { %w[id body created_at updated_at question_id user_id] }
        let(:resource_response) { json['answers'].min_by { |a| a['id'] } }
  ...
  describe 'PATCH /api/v1/answers/:id' do
    ...
    context 'authorized' do
      context 'with valid attributes' do
        before do
          patch api_path, params: { id: answer, answer: { body: 'new body' }, access_token: access_token.token }
        end
